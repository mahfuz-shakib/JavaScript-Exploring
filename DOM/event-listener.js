...
btn.addEventListener("click",myFunction);   /*  Note: here not use the 'on' prefix  */
function myFunction()
{
...
heading2.addEventListener("mouseover",function(){heading2.innerHTML="Bangladesh 2.0 2025";});
heading2.addEventListener("mouseout",function(){heading2.innerHTML="July Revolution 2025";});
